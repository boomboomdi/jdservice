...
import flask
import requests
from jingdong import create_order
from jingdong import create_df_order
...
def createOrder():
    ...
    # print(account)
    # print(skuid)
    # code, pay_url, order_id = create_order(account, ck, amount, skuid)
    code, pay_url, order_id = create_df_order(account, ck, amount, skuid)
    if code == SUCCESS:
        order_info = {
            'payUrl': pay_url,
            'orderNo': order_id,
