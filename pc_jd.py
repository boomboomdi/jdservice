...
def create_order_appstore(ck, order_me, amount, proxy):
    ...
    code, pay_id = app_client.gen_app_payid(order_no, '34', amount)
    if code != SUCCESS:
        return code, None
    code, order_no = app_client.pay_index(pay_id)
    if code != SUCCESS:
        return code, None
...
if __name__=='__main__':
    ...
    ck = 'TrackID=1s6q01v8cz2TmVY_fZWoBpILUCklCMc3tOOMLLiz4AIFW1v-OhIiUzor0GKTxrRQZwghYFLhUrxZTq-S62_WXnw; thor=; pinId=NgmMw_9pPe9h2KttD8D8Uw; pin=difang8298; unick=difang8298; _tp=rp7kkxhk5etAo1ICrznwKA%3D%3D; _pst=difang8298; upn=7XdO4cpF4chB; pin=difang8298; wskey=AAJigmpYAEAv7ir-GCfR6xzhTTb8rK6cFJJOIcmisU2HFr183dAnGsVyAhAMU3jMgTzpGHx9DtVdr-LFbfTDjpt18Xi16THM;'
